...
<p><strong>CIS Benchmark Reference:</strong> This audit follows the official CIS Microsoft Windows Server 2022 Benchmark. Download the official documentation at: <a href="https://www.cisecurity.org/cis-benchmarks" target="_blank">https://www.cisecurity.org/cis-benchmarks</a></p>
<div class="note-box">
