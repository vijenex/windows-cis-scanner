...
<p><strong>CIS Benchmark Reference:</strong> This audit follows the official CIS Microsoft Windows Server 2025 Benchmark. Download the official documentation at: <a href="https://www.cisecurity.org/cis-benchmarks" target="_blank">https://www.cisecurity.org/cis-benchmarks</a></p>
<div class="note-box">
...
Write-Host "   Windows CIS Benchmark Audit Tool – DISCLAIMER" -ForegroundColor Yellow
Write-Host "===============================================================" -ForegroundColor Yellow
Write-Host "" -ForegroundColor White
Write-Host "This tool is open-source and provided strictly for AUDIT purposes." -ForegroundColor White
Write-Host "It does NOT perform any automatic remediation, modification, or" -ForegroundColor White
Write-Host "enforcement of system settings." -ForegroundColor White
Write-Host "" -ForegroundColor White
Write-Host "All findings generated by this script must be carefully reviewed" -ForegroundColor White
Write-Host "by a qualified Windows Administrator. Any configuration changes" -ForegroundColor White
Write-Host "should first be validated in a NON-PRODUCTION or TEST environment" -ForegroundColor White
Write-Host "before being applied to PRODUCTION." -ForegroundColor White
Write-Host "" -ForegroundColor White
Write-Host "For official remediation guidance, always refer to the CIS" -ForegroundColor White
Write-Host "(Center for Internet Security) Benchmark documentation." -ForegroundColor White
Write-Host "" -ForegroundColor White
Write-Host "The authors and contributors of this tool are NOT responsible for" -ForegroundColor Red
Write-Host "any misconfigurations, system impact, or incorrect changes made" -ForegroundColor Red
Write-Host "based on the audit results." -ForegroundColor Red
Write-Host "" -ForegroundColor White
Write-Host "By using this tool, you acknowledge and accept these terms." -ForegroundColor White
Write-Host "===============================================================" -ForegroundColor Yellow
Write-Host "" -ForegroundColor White

# Confirmation prompt
$response = Read-Host "Do you want to proceed with the scan? (y/n)"
if ($response -ne 'y' -and $response -ne 'Y' -and $response -ne 'yes' -and $response -ne 'Yes') {
